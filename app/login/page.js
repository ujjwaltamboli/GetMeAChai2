    ...
    return (
        <div className="bg-[#000000] bg-[radial-gradient(#ffffff33_1px,#00091d_1px)] bg-[size:20px_20px] flex flex-col items-center">
            <div className="flex flex-col items-center text-2xl text-white">
                <p className='font-bold py-10'>Login to get your fans to support you</p>
            </div>
            ...
            <div className="flex flex-col gap-2 p-10 min-h-screen">
                ...
                <button
                    className="flex items-center bg- border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-gray-200 hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                ...
                <button
                    className="flex items-center bg- border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-gray-200 hover:text-black focus:outline-none focus:r
    ing-2 focus:ring-offset-2 focus:ring-gray-500">
                    <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
